...
- **Pattern**: [[mcp-secret-projection-pattern]] (Proiezione Segreti & Immutabilità MCP Server), [[mcp-registry-package-pattern]] (Packaging MCP da Registry Ufficiali npm/PyPI), [[mcp-upstream-tracking-pattern]] (Tracciamento Controllato Upstream Git per Container MCP).
