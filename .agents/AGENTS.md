...
- **Obbligo di Rigenerazione del Contesto Wiki (Rif: wiki/SCHEMA.md#13)**: Ogni volta che l'agente crea, modifica o elimina un file markdown (`.md`) all'interno della cartella `wiki/`, è obbligatorio eseguire lo script di rigenerazione al termine della sessione di editing prima di effettuare il commit:
