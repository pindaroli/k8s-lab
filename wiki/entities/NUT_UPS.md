...
- **Host Master**: **TrueNAS SCALE** (`10.10.20.50`, Bare Metal). Il cavo USB è attestato fisicamente su TrueNAS.
...
- **Monitoraggio**: `/etc/nut/upsmon.conf` configurato per monitorare `ups@10.10.20.50:3493` con utente `pvemon`.
